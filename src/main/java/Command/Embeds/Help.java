    ...
    public void handle(CommandContext context) {
        EmbedBuilder builder = new EmbedBuilder().setAuthor("LOKOMOTIV PLOVDIV ULTRA", context.getGuild().getVanityUrl(),
                ...
                .addField("<:league:707659747662233680> League of Legends",
                        ...
                        false)
                .addField("<:shield:728590447886336071> Admin", "`lp set league command enabled`, `lp set league command disabled`", false)
                .addField("<:wrench:707714476572672020> Other", "`lp pfp`, `lp pfp @[user]`", false)
